...
// Props
type DeleteSystemDropdownDialogProps = {
...
const DeleteSystemDropdownDialog = ({
  open,
  setOpen,
  refetch,
}: DeleteSystemDropdownDialogProps) => {
  // Zustand store
  ...
  const onSubmit = (e: React.SubmitEvent<HTMLFormElement>) => {
    ...
    toast.promise(
      mainInstance.delete(`/system/dropdowns/${selectedSystemDropdown?.id}`),
      {
        loading: 'Loading...',
        success: () => {
          refetch();
      ...
      <DialogContent>
        <form onSubmit={onSubmit}>
          <DialogBody>
            ...
            {/* Modal title */}
            <h3 className="text-center text-xl">Delete System Dropdown</h3>
...
export default DeleteSystemDropdownDialog;
